...
{
    public partial class HotstringSimple : IComparable, IComparable<CommandSimple>, INotifyDirtyData, INotifyDataErrorInfo, INotifyPropertyChanged
    {
        #region Fields
        private Type MyType;
        ...
        /// <summary>
        /// Gets/Sets the plugin file that this Hotstring exist in
        /// </summary>
        public string File
        {
            get
        ...
        /// <summary>
        /// Gets/Sets the Trigger of the Hotstring
        /// </summary>
        public string Trigger
        {
            ...
            set
            {
                if (this.m_Trigger != value)
                {
                    this.SetPropertyValue(value, () => this.m_Trigger = value);
                }
        ...
        /// <summary>
        /// Gets/Sets the name of the Hotstring
        /// </summary>
        public string Name
        {
            get
        ...
        /// <summary>
        /// Gets/Sets the Description of the Hotstring
        /// </summary>
