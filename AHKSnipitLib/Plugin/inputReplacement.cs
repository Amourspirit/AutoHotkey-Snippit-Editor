...
{
    public partial class inputReplacement : IReplacement
    {
        [XmlIgnore()]
        private static string m_ReplacementName = Properties.Resources.ReplacementNameDialogInput;
        ...
        public ReplacementEnum ReplacementType
        {
            get
            {
                return ReplacementEnum.InputDialog;
            }
        }
    }
}
